      ...
      <main data-bg="light" style={{ minHeight: "100vh", background: "#fdf9f4", display: "flex", alignItems: "center", justifyContent: "center", padding: "8rem 1.5rem 4rem" }}>
        <div style={{ width: "100%", maxWidth: "400px" }}>
          <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
            ...
            <p style={{ fontFamily: "var(--font-outfit), sans-serif", color: "#999", fontSize: "0.9rem", marginTop: "0.5rem" }}>Login with your registered mobile number and date of birth</p>
          </div>
          ...
          <form onSubmit={handleLogin} style={{ background: "#fff", borderRadius: "24px", padding: "2rem", boxShadow: "0 2px 24px rgba(27,60,51,0.04)" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
              <div>
                ...
                <input required value={phone} onChange={(e) => { const d = e.target.value.replace(/\D/g, "").slice(0, 10); setPhone(d); }} style={inputStyle} placeholder="XXXXXXXXXX" inputMode="numeric" pattern="[0-9]{10}" maxLength={10} />
              </div>
              <div>
