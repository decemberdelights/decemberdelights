...
export default function MenuTab({ items, role, onAdd, onEdit, onDelete }: MenuTabProps) {
              ...
              <tr key={m.id}>
                ...
                <td>
                  <div className="row-actions">
                    ...
                    {role === "super_admin" && <button className="btn danger" onClick={() => onDelete(m.id)}>Delete</button>}
                  </div>
                </td>
              </tr>
            ))}
