...
export default function ProductsTab({ products, role, onAdd, onEdit, onDelete }: ProductsTabProps) {
              ...
              <tr key={p.id}>
                ...
                <td>
                  <div className="row-actions">
                    ...
                    {role === "super_admin" && <button className="btn danger" onClick={() => onDelete(p.id)}>Delete</button>}
                  </div>
                </td>
              </tr>
            ))}
