...
export default function JobsTab({ jobs, role, onAdd, onEdit, onDelete }: JobsTabProps) {
              ...
              <tr key={j.id}>
                ...
                <td>
                  <div className="row-actions">
                    ...
                    {role === "super_admin" && <button className="btn danger" onClick={() => onDelete(j.id)}>Delete</button>}
                  </div>
                </td>
              </tr>
            ))}
