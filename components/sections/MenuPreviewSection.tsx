...
export default function MenuPreviewSection() {
  const revealRef = useScrollReveal(0.12, "0px 0px -40px 0px", { animation: "slideUp3D", stagger: 0.06 });
  return (
    <>
      <div data-bg="light" className="menu-section">
        <LazyVideo src="/DDespresso.mp4" className="menu-video-bg" data-parallax="0.15" />
        <div ref={revealRef} className="menu-content section-reveal" data-parallax="-0.08">
          <span style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "16px", fontWeight: 700, letterSpacing: "6px", textTransform: "uppercase", color: "#c8a97a", marginBottom: "20px", display: "block" }}>
            <ScrollFloat animation="slideUp3D" containerClassName="!my-0">What We Serve</ScrollFloat>
          </span>
          ...
          <div style={{ marginBottom: "40px" }}>
            <div className="menu-grid-equal">
              {mustTryItems.map((item, i) => (
                <div key={i} className="menu-card-vert" data-reveal-child>
          ...
          <Link href="/menu" style={{ padding: "14px 40px", fontFamily: "'Montserrat', sans-serif", fontSize: "12px", fontWeight: 600, letterSpacing: "2px", textTransform: "uppercase", color: "#fff", background: "#074134", border: "none", borderRadius: "999px", cursor: "pointer", textDecoration: "none", display: "inline-block" }}>
            View Full Menu
          </Link>
        </div>
      </div>
