    ...
    <>
      <div data-bg="dark" className="career-section">
        <div className="career-text">
          <span data-reveal="fade-up" style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "16px", fontWeight: 700, letterSpacing: "6px", textTransform: "uppercase", color: "#c8a97a", marginBottom: "20px", display: "block" }}>Career</span>
          <div data-reveal="fade-up" className="delay-1" style={{ width: "60px", height: "3px", background: "#c8a97a", marginBottom: "32px" }} />
          <h2 data-reveal="fade-up" className="delay-2 career-heading">
            <ScrollFloat containerClassName="!my-0">Brew Your</ScrollFloat><br />
            <ScrollFloat containerClassName="!my-0">Career</ScrollFloat>
          </h2>
          <p data-reveal="fade-up" className="delay-3" style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 400, lineHeight: 1.8, color: "rgba(255,255,255,0.85)", marginBottom: "40px", maxWidth: "540px" }}>
        ...
        <div data-reveal="fade-left" className="delay-2 career-video-wrap">
          <LazyVideo
            src="/espresso.mp4"
